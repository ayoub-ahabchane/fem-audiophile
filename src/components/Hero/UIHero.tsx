...
const UIHero = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-6 pb-[7rem] pt-[12.375rem] md:pb-[10.4375rem] md:pt-[13.5rem] lg:mx-auto lg:max-w-[79.375rem] lg:items-start lg:px-20">
        <div className="flex flex-col items-center gap-4 md:gap-6 lg:items-start">
          <h1 className="order-2 max-w-[16.5rem] text-center  text-h2-mobile uppercase md:max-w-[24.75rem] md:text-h1 lg:text-left">
            {headline}
          </h1>
          <span className="order-1 text-overline uppercase text-white/50">
            {overline}
          </span>
        </div>
        <p className="max-w-[16.5rem] text-center text-white/75 md:mb-5 md:max-w-[21.8125rem] lg:text-left">
          {subhead}
        </p>
        <Cta {...cta} />
      </div>
